...
import 'package:cartlist/MODAL/addCartModal.dart';
import 'package:flutter/material.dart';
import 'package:http/http.dart' as http;

Future<NetworkResponse<AddCartModal>> addToCartData({
  ...
  try {
    final data = http.MultipartRequest(
        'POST', Uri.parse('http://18.183.210.225//cartlist_api/addtocart.php'));
    data.fields.addAll({
      'pass_userID': userID,
      'pass_phoneNumber': phoneNumber,
      'pass_product_name': productName,
      'pass_product_brand': productBrand,
      ...
      'pass_cartid': userID + cartNumber + productQuantity,
    ...
    if (response.statusCode == 200) {
      ...
      AddCartModal cartDatamodal = AddCartModal.fromJson(jsonString);

      return NetworkResponse(true, cartDatamodal,
