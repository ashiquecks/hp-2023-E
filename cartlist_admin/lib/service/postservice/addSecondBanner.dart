...
class AddSecondBannerservice {
  static Future<NetworkResponse<AddBannerModal>> addSecondBanner({
    ...
    try {
      var request = http.MultipartRequest(
          'POST',
          Uri.parse(
              'http://18.183.210.225/cartlistapp_api/admin/post_data/add_secondbanner.php'));
